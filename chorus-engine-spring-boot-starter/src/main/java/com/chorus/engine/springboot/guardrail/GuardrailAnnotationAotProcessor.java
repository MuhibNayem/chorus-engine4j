...
public class GuardrailAnnotationAotProcessor implements BeanFactoryInitializationAotProcessor {
    ...
    public BeanFactoryInitializationAotContribution processAheadOfTime(ConfigurableListableBeanFactory beanFactory) {
        ...
        for (String beanName : beanFactory.getBeanDefinitionNames()) {
            ...
            if (beanClass != null && AnnotationUtils.findAnnotation(beanClass, Guardrail.class) != null) {
                hasGuardrail = true; break;
            }
        }
        if (!hasGuardrail) return null;
        return new GuardrailAnnotationAotContribution(beanFactory);
    }
    ...
    private static final class GuardrailAnnotationAotContribution implements BeanFactoryInitializationAotContribution {
        private final ConfigurableListableBeanFactory beanFactory;
        GuardrailAnnotationAotContribution(ConfigurableListableBeanFactory beanFactory) { this.beanFactory = beanFactory; }
        ...
        public void applyTo(org.springframework.aot.generate.GenerationContext ctx, BeanFactoryInitializationCode code) {
            ...
            for (String beanName : beanFactory.getBeanDefinitionNames()) {
                ...
                if (AnnotationUtils.findAnnotation(beanClass, Guardrail.class) == null) continue;
